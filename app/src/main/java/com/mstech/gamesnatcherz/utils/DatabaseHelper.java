...
import com.mstech.gamesnatcherz.model.ImageQuiz;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "gamesnatcherz.db";
...
//    public long insertQuestion(String spellingbeeQuizId, String questions, String position, String answers, String time, String points ,
//                               String answeredcount, String correctansweredcount ) {
...
//        db.delete(QuizData.TABLE_NAME, null, null);
        ...
        db.delete(TextQuiz.TABLE_NAME, null, null);
        db.close();
    }
}
