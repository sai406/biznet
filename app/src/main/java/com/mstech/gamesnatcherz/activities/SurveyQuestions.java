...
public class SurveyQuestions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        surveyquestionimageid=(CardView) findViewById(R.id.surveyquestionimageid) ;
    ...
    public void Offerdata() {
        ...
        String url=" http://gamesnatcherz.com/api/InsertCustomerSurveyAnswer?sid="+serid+"&cid="+custid+"&qid="+SurveyquestionId
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(Survey.has("SurveyquestionId")) {
                                ...
                                options.setVisibility(View.GONE);
                                q.setVisibility(View.GONE);message.setVisibility(View.GONE);
                                next.setVisibility(View.GONE);
